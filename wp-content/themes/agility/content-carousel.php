<?php
/**
 * The template used for displaying carousel slides
 *
 * @package Agility
 * @since Agility 1.2
 */
 
global $post, $slide_img_size, $carousel_item_class;
...
<li class="<?php echo $slide_class; ?> slide-<?php the_ID(); ?> one-third column <?php echo $carousel_item_class; ?>" >
	...
	<div class="<?php echo $captionClass; ?>">
		...
		<?php if( $displayCaption && $caption ): ?>
		<span class="caption-text"><?php echo $caption; ?></span>
		<?php endif; ?>
