...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?>>
	...
	<footer class="entry-meta">
		<?php /* translators: used between list items, there is a space after the comma */
			...
			if( $tag_list ): ?>
		<span class="post-tags tooltip-container"><a href="#" class="icon icon-tags tooltip-anchor"></a><span class="tooltip"><?php
			echo $tag_list;
		?></span></span>
		<?php endif; ?>

		<?php if ( comments_open() ): ?>
		<span class="post-comments tooltip-container"><i class="icon icon-comments tooltip-anchor"></i><span class="tooltip"><?php comments_number(); ?></span></span> 
		<?php endif; ?>
