...
$data_thumb = wp_get_attachment_image_src( $post_thumbnail_id, 'crop_640' );
$data_thumb = $data_thumb[0];
...
<li class="<?php echo $slide_class; ?> slide-<?php the_ID(); ?>" data-thumb="<?php echo $data_thumb; ?>" >
