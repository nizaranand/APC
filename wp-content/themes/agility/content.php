...
<article id="post-<?php the_ID(); ?>" <?php post_class( $post_class ); ?>>
	...
	<header class="entry-header">
		...
		<?php if( !$is_latest && $show_feature ): ?>
			<?php agility_featured_image( agility_standard_format_image_size( $post->ID, 640 , 'standard' ), $left_class ); ?>
		<?php endif; ?>
		...
		<footer class="entry-meta">
			<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
				...
				<?php
					...
					if ( $tags_list ) :
				?>
				<span class="tag-links tooltip-container"><a href="#" class="icon icon-tags tooltip-anchor"></a><span class="tooltip"><?php 
					echo $tags_list; ?></span>
				</span>
