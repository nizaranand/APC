...
if( $agilitySettings->op( 'home-featured-carousel-crop' ) ) $carousel_img_size = 'crop_640';
		...
		<div id="main-container" class="container">
			...
			<div id="primary" class="site-content">
				...
				<div id="content" >
					...
					<?php if( $agilitySettings->op( 'home-show-carousel' ) ): ?>
					<div class="sixteen columns">
						<?php agility_item_carousel( $agilitySettings->op( 'home-featured-carousel' )  , 'slider_id', $carousel_img_size ); ?>
					</div>
					<?php endif; ?>
					...
					<?php 
					$blog_query_id 	= get_post_meta( $post->ID , 'blog_query_id' , true );
